package com.yxf.backstage.plugins.google;
 ...
 * @author win
 * <li class="langLi" langs-lang="en">English</li> 英语       </br>
 * <li class="langLi" langs-lang="ja">日本語</li>日语         </br>
 * <li class="langLi" langs-lang="ru">русский</li>俄语        </br>
 * <li class="langLi" langs-lang="es">Español</li>西班牙语    </br>
 * <li class="langLi" langs-lang="zh_cn">简体中文</li>        </br>
 * <li class="langLi" langs-lang="ch_tw">繁體中文</li>        </br>
 * <li class="langLi" langs-lang="ko">한국어</li>韩语         </br>
 * <li class="langLi" langs-lang="de">Deutsch</li>德语        </br>
 * 谷歌翻译类 </br>
 * 经过google发现还有更简单的方式：</br>
 * "https://translate.googleapis.com/translate_a/single?client=gtx&sl={fromCulture}&tl={toCulture}&dt=t&q={text}" </br>
 * client ,dt 两个参数不要修改，不然无法正常工作</br>
 * sl 为要翻译的文本语言，如果不知道，可以为auto </br>
 * tl 为目标语言。必须指定 </br>
 * q 为要翻译的文本。注意中文的 UrlEncoded 问题 </br>
 */
